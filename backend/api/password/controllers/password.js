...
module.exports = {
  reset: async ctx => {
	...
	// console.log("dsfkljdsjgf--------", params)
	...
	if ( params.newPassword && params.confirmPassword && params.newPassword !== params.confirmPassword) {
	  	return ctx.badRequest(
			null,
			formatError({
	...
	} else if ( params.newPassword && params.confirmPassword && params.newPassword === params.confirmPassword) {
